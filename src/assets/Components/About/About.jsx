...
const About = () => {
  ...
  return (
    <div
      id="About"
      className="text-text-primary min-h-screen bg-gradient-to-b from-bg-primary to-bg-secondary pt-24 transition-colors duration-300"
    >
        ...
        <div className="flex flex-col md:flex-row items-center gap-12 pt-4 md:pt-10">
          ...
          <div className="md:w-5/12 flex justify-center animate-on-scroll" id="element-1">
            <div className={`relative transition-all duration-1000 ease-out ${animatedElements['element-1'] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}>
              ...
              <img
                className="w-64 md:w-80 rounded-full border-4 border-border-primary shadow-2xl relative z-10 hover:scale-105 transition-transform duration-300"
                src={avatar}
                alt="Profile Avatar"
              />
            </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-10">
            <div className="animate-on-scroll" id="element-3">
              <div className={`card card-hover p-6 h-full transition-all duration-1000 ease-out ${animatedElements['element-3'] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}>
                <div className="p-3 bg-primary/20 rounded-full w-14 h-14 flex items-center justify-center mb-5">
                  <FaLaptopCode className="text-primary text-2xl" />
                </div>
                <h3 className="text-xl font-bold mb-4 text-text-primary">Technical Expertise</h3>
            ...
            <div className="animate-on-scroll" id="element-4">
              <div className={`card card-hover p-6 h-full transition-all duration-1000 ease-out ${animatedElements['element-4'] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}>
                <div className="p-3 bg-secondary/20 rounded-full w-14 h-14 flex items-center justify-center mb-5">
                  <FaReact className="text-secondary text-2xl" />
                </div>
                <h3 className="text-xl font-bold mb-4 text-text-primary">Development Approach</h3>
                <p className="text-text-secondary mb-4">
          ...
          <div className="animate-on-scroll" id="element-5">
            <div className={`glass p-8 rounded-xl shadow-lg text-center border-2 border-primary/20 transition-all duration-1000 ease-out ${animatedElements['element-5'] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}>
              <h3 className="text-xl md:text-2xl font-bold mb-4 text-text-primary">Let's Work Together</h3>
              <p className="text-base md:text-lg mb-6 text-text-secondary">
                Feel free to explore my <Link to="/portfolio" className="text-primary hover:underline font-medium">projects</Link> or reach out if collaboration sounds exciting!
              </p>
              <button
